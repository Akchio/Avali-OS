...
Avali-OS is currently being completely reworked, recoded, and migrated to KDE Plasma. The original (base) version is now deprecated. During this process, users should expect a "radio blackout" from the developer with limited updates or announcements until the new version is ready. We're excited to announce that the release is just two days away!
